...
std::mt19937 RandomNameGenerator::prng = std::mt19937{std::random_device{}()};
...
std::string get_random_name() {
    ...
    name << first_names[fnd(RandomNameGenerator::prng)] << ' '
         << last_names[lnd(RandomNameGenerator::prng)];
    return name.str();
}
